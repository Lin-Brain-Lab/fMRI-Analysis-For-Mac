...
20. `recon-all -subjid XXXXX all-` where XXXXX is your subject ID, this step will take about 10 hours to complete the whole processing
...
6. `recon-all -subjid XXXXX all-` where XXXXX is your subject ID
