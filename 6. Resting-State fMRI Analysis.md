...
5. Make sure your directory is /Users/jessica/data_analysis/seeg/s025/resting_analysis and run. If done successfully the output should be "DONE!" and there should be two hippo_fconn_native_vol_aseg_120423_gavg_hippo_left-anat-lh.stc and two s025_2_fsaverage_hippo_fconn_032124-lh.stc files (one lh one rh) in your resting_analysis folder 
