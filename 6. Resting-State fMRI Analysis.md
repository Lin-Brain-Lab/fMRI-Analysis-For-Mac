...
## Seed Time Series
1. Download [get_native_hippo_regressor_rest.m](https://github.com/fahsuanlin/labmanual/blob/master/scripts/get_native_hippo_regressor_032124.m)
2. Change lines 4, 14, 24, 34, and 57 to your respective folder locations, subject directory, subject ID, and dicom number. Comment out lines 5 and 15
3. Make sure your directory is /Users/jessica/data_analysis/seeg/s025/resting_analysis and run. If done successfully, output should be "DONE!"
