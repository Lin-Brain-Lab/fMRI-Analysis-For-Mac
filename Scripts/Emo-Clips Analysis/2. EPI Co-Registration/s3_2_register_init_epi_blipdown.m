...
file_overlay_register=['./bb_register_blipdown_init_05.dat']
%file_overlay_vol='epi__epi_blipdown.mgh';
file_overlay_vol='epi_005_f.mgh'; %use this one because SMS-InI has flipped A-P direction compared to EPI.
overlay_threshold=[];
