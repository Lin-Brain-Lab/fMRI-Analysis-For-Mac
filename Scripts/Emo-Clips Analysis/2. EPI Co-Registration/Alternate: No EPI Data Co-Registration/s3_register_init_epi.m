...
file_overlay_register='./bb_register_epi_03.dat';
file_overlay_vol='mb_run_3_ref.mgh';
overlay_threshold=[];

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
setenv('SUBJECTS_DIR','/Users/jessica/data_analysis/emoclips/subjects/'); %for MAC/Linux
%setenv('SUBJECTS_DIR','D:\fhlin\Users\fhlin\workspace\seeg\subjects'); %for PC

mri=MRIread(sprintf('/Users/jessica/data_analysis/emoclips/subjects/%s/mri/orig.mgz',subject)); %for MAC/Linux
...
%
%2. check initial registration at command line: tkregisterfv --mov smsini_mb_run_1_ref.mgh --reg bb_register_init.dat --surfs  --sd /Users/fhlin/workspace/eegmri_music/subjects/
