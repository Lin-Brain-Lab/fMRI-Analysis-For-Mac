...
erfmri_para={
     's014_emoclips_001_soa.para';
%    's014_emoclips_002_soa.para';
%    's014_emoclips_003_soa.para';
%    's014_emoclips_004_soa.para';
    };
...
hypothesis{1}.rv=[4]; %index to glm_var 
hypothesis{1}.cvec=[1];
% hypothesis{2}.rv=[7]; 
% hypothesis{2}.cvec=[1];
% hypothesis{3}.rv=[5 6]; 
% hypothesis{3}.cvec=[1 -1]; 

output_stem='run_1_smsini_soa_gavg_glm';
%------------------------------------------------------------------------------------
