...
1. Download [show_individual_surf.m](https://github.com/fahsuanlin/labmanual/blob/master/scripts/show_individual_surf_031324.m) and add to your seeg/group_level_analysis/resting_state folder and open in MatLab 
