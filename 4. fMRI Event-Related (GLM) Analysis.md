...
## Map fMRI time series from EPI volumes on cortical surfaces
...
2. In MatLab create a script called fdr.m with the follow code and add this file to your seeg/group_level_analysis/event_related folder
```
