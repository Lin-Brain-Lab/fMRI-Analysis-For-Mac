...
### 4.3 Calculate the FDR-Corrected Threshold for the Overall Activation Across All 3 Runs
...
3. If done successfully you should have one image that is the average of all three runs. This script also outputs the FDR-corrected threshold

### 4.4 Differential Contrast 
1. For the Individual vs. Group-Averaged contrast, use [g5_differential_contrast.m](https://github.com/Lin-Brain-Lab/fMRI-Analysis-For-Mac/blob/main/Scripts/Emo-Clips%20Analysis/4.%20Group-Level%20Analysis/g5_differential_contrast.m) and use the file name you put in the output_stem in step 4.2
