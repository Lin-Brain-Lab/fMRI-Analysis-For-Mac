...
```
bbregister --s s001 --mov mb_run_1_ref.mgh --init-reg bb_register_init_01.dat --reg bb_register_epi_01.dat --bold
bbregister --s s001 --mov mb_run_2_ref.mgh --init-reg bb_register_init_02.dat --reg bb_register_epi_02.dat --bold
bbregister --s s001 --mov mb_run_3_ref.mgh --init-reg bb_register_init_03.dat --reg bb_register_epi_03.dat --bold
```
