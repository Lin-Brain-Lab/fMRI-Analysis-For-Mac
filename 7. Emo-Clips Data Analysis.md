...
6. Change from line 7 of [fmri_smsini_soa_gavg_glm.m](https://github.com/Lin-Brain-Lab/fMRI-Analysis-For-Mac/blob/main/Scripts/Emo-Clips%20Analysis/3.%20GLM/s6_fmri_smsini_soa_gavg_glm.m) to your .stc files and from line 27 to your .para files
7. Change from line 34 to include the triggers for your dataset
8. Change line 61 to the output name for each run `output_stem='run_2_smsini_soa_gavg_glm';` and run each run seperately.
