...
4. Change from line 27 of [fmri_smsini_soa_gavg_glm.m](https://github.com/fahsuanlin/labmanual/blob/master/scripts/fmri_smsini_soa_gavg_glm.m) to your .para files
```
erfmri_para={
...
5. Change from line 34 to include the triggers for your dataset
```
glm_var={
    [1 2 3 4 5]; %face
