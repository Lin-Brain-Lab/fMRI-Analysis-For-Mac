...
7. download lab manual master zip 
...
1. Download [read_outside_eeg_042124.m](https://github.com/fahsuanlin/labmanual/blob/master/scripts/read_outside_eeg_042124.m)
2. change like 153, 185, 192 from pan_tompkin2 to pan_tompkin
3. there should be a fivuew 1 and 2 popup
  <details>
...
4. Examine results with `etc_trace(cat(1,EEG_orig,ECG_orig),'fs',fs(1),'ch_names',label,'aux_data',{cat(1,EEG,ECG)})` a popup window 
<details>
...
6. Download [get_outside_erp.m](https://github.com/fahsuanlin/labmanual/blob/master/scripts/get_outside_erp.m)
7. Download [show_erp_scalp.m](https://github.com/fahsuanlin/labmanual/blob/master/scripts/show_erp_scalp.m) should have popup
<details>
...
9. Download [topology_31ch_default.mat](https://github.com/fahsuanlin/labmanual/blob/master/scripts/topology_31ch_default.mat) open and click finish
10. Download [read_inside_eeg_042124.m](https://github.com/fahsuanlin/labmanual/blob/master/scripts/read_inside_eeg_042124.m)
12. change from line 3 to
```
headerFile = {
...
```
14. to check using `etc_trace(cat(1,EEG_orig,ECG_orig),'fs',sfreq,'ch_names',label,'aux_data',{cat(1,EEG,ECG)},'trigger',TRIGGER);`
15. Download [get_inside_erp.m](https://github.com/fahsuanlin/labmanual/blob/master/scripts/get_inside_erp.m)
16. Download [show_erp_scalp.m](https://github.com/fahsuanlin/labmanual/blob/master/scripts/show_erp_scalp.m)
...
18. download [read_smsini_eeg_042124.m](https://github.com/fahsuanlin/labmanual/blob/master/scripts/read_smsini_eeg_042124.m)
19. dwn [get_smsini_erp.m](https://github.com/fahsuanlin/labmanual/blob/master/scripts/get_smsini_erp.m)
20. Download [show_erp_scalp.m](https://github.com/fahsuanlin/labmanual/blob/master/scripts/show_erp_scalp.m)
