...
7. Download [show_erp_scalp.m](https://github.com/fahsuanlin/labmanual/blob/master/scripts/show_erp_scalp.m) and add it to your eeg_analysis folder and run, there should have pop-up. If you click the highlighted blue region on the scalp render, there should be a ERP plot pup-up
<details>
...
16. Download [show_erp_scalp.m](https://github.com/fahsuanlin/labmanual/blob/master/scripts/show_erp_scalp.m) and add it to your eeg_analysis folder and run, there should be a pup-up
<details></details>
