...
1. Download [read_erp_041019.m](https://github.com/fahsuanlin/labmanual/blob/master/scripts/read_erp_041019.m) to your subjects eeg_analysis folder. This script calculated the evoked potentials.
### Examine Evoked Fields
1. Download [show_erp.m](https://github.com/fahsuanlin/labmanual/blob/master/scripts/show_erp.m) to your subjects eeg_analysis folder. This script shows the evoked potentials on a 2-D plot.
### Prepare Brain/Head Geometries
1. `mne_setup_mri --subject 180330_SYH`
2. `mne_setup_source_space --subject 180330_SYH --spacing 5`
3. `mne_watershed_bem --subject 180330_SYH`
