...
To change the colourmap to a heatmap view, toggle the lefthand control window under colourmap and select heatmap
...
13. Change line 24 to the subject ID you are working on
14. Comment out line 70 (anything after 'end;')
15. If done successfully, you should have a stc file for each of your mb_run files
